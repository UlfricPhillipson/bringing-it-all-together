...
function playCraps(){
    ...
    // the catch all -the dice roll is a tie
        ...
        document.getElementById("crapsRes").style.color = "black";
...
/*
    generate the factorial of 7
*/
function factorial(){
    var result = 7;
    var nextStep = result - 1;
    for(let i = nextStep; i > 0; i--){
        result *= i;
        console.log
    }
    document.getElementById("facRes").innerHTML = result;
}
